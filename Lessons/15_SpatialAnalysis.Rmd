...
> _Now you try_: Read in the NC 8-Digit HUC dataset: './Data/Spatial/8Digit_HUC_Subbasins.shp'. What CRS does this dataset use? Is it the same as the counties dataset? What columns are included in this dataset?
...
> Exercise: Try subsetting the HUc2 dataset for SUB = 0302, then clipping counties with that subset.
