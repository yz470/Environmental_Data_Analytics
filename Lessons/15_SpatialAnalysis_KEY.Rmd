...
#Buffer the site
theSite_buffer <- st_buffer(theSite_sfc_transformed,30000)

#Select features that intersect the buffer
selMask <- st_intersects(counties_sf_utm,theSite_buffer,sparse=FALSE)
selCounties <- counties_sf_utm[selMask,]
mapview(selCounties)
```
