...
> ANWSER: Ozone AQI values in 2017-2018 were significantly lower than 50 (one sample t-test; t = -41.9, df = 184, p < 0.0001)
...
var.test(EPAair$Ozone ~ EPAair$Site.Name) # the variance between these population is different
...
> ANSWER: (ANOVA; F = 16.16 df = 1898, p < 0.0001)
