...
theme_set(mytheme) #set mytheme as the default theme
...
# change your axis labels to reflecLaket TN and TP in micrograms per liter.
# change your legend labels
NvsP2 <-
  ggplot(PeterPaul.chem.nutrients, aes(x = tp_ug, y = tn_ug, fill = depth, shape = lakename)) +
  geom_point(alpha = 0.8, size = 3) +
  xlab(expression("Total Nitrogen (\U003BCg/L)")) +
  ylab(expression("Total Phosphor (\U003BCg/L)")) +
 # labs(x = "Total Nitrogen (\U003BCg/L)" ,y = "Total Phosphor (\U003BCg/L)",fill = "depth,m", shape="Lake")
...
# place your additional edits here
  labs(y= "Concentration (\U003BCg/L)",x = "" )  +
