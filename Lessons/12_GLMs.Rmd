...
> ANSWER: Every unit increase in depth will lead to 95.89 decrease in irradiance.(linear regression; R-square = 0.31, df = 15449, p < 0.0001)
...
irradiancebydepth2 <- 
    ...
    labs(y = "Irradiance(units)", x = "Depth(m)")+
