...
vector1[3] # call out the third element of vector1

# Matrices ----
matrix1 <- matrix(1:20, nrow = 5,ncol = 4) # create a matrix from 1 to 20 that has 5 rows and 4 columns
matrix1
matrix2 <- matrix(1:20, nrow = 5, ncol = 4, byrow = TRUE) #count by row. The default is counting by column
matrix2
...
matrix1[4, ] # call out row 4 
matrix1[ , 3] # call out column 3
matrix1[c(12, 14)] # call out elements 12 and 14
matrix1[c(12:14)] # call out elements 12 to 14
matrix1[2:4, 1:3] # call out row 2 through 4 and column 1 through 3
...
dataframe1[1:2] # call out columns 1 and 2 
dataframe1[c("ID","Passed")] # call out columns whose names are ID and Passed 
dataframe1$Color # 

```
QUESTION: How do the different types of data appear in the Environment tab?

> ANSWER: The appear as dataframe, list and matrix.

QUESTION: In the R chunk below, write "dataframe1$". Press `tab` after you type the dollar sign. What happens?

> ANSWER: the column names pop up
