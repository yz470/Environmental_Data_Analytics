...
NTL.phys.data.JunethruOctober2 <- filter(NTL.phys.data, daynum > 151, daynum < 305) # here "," equal to "&"
...
NTL.phys.data.year.1990to1999 <- filter(NTL.phys.data, year4 >= 1990, year4 <= 1999 & lakename =="Tuesday Lake")

```
Question: Why don't we filter using row numbers?

> ANSWER: not reproducible and inconvenient 
...
# East Long lake in 1998-7-16 at depth of 0.5m 
```
### Select
