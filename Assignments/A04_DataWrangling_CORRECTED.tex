...
\StringTok{  }\KeywordTok{summarise}\NormalTok{(}\DataTypeTok{meanAQI_O3 =} \KeywordTok{mean}\NormalTok{(Ozone),}
            \DataTypeTok{meanAQI_PM2.5 =} \KeywordTok{mean}\NormalTok{(PM2.}\DecValTok{5}\NormalTok{))}
...
\StringTok{  }\KeywordTok{summarise}\NormalTok{(}\DataTypeTok{meanAQI_O3 =} \KeywordTok{mean}\NormalTok{(Ozone),}
            \DataTypeTok{meanAQI_PM2.5 =} \KeywordTok{mean}\NormalTok{(PM2.}\DecValTok{5}\NormalTok{),}
            \DataTypeTok{minAQI_O3 =} \KeywordTok{min}\NormalTok{(Ozone),}
            \DataTypeTok{minAQI_PM2.5 =} \KeywordTok{min}\NormalTok{(PM2.}\DecValTok{5}\NormalTok{),}
            \DataTypeTok{maxAQI_O3 =} \KeywordTok{max}\NormalTok{(Ozone),}
            \DataTypeTok{maxAQI_PM2.5 =} \KeywordTok{max}\NormalTok{(PM2.}\DecValTok{5}\NormalTok{))}
\CommentTok{#13}
...
## 1 Blacksto~       38.3          36.7         8            0        97
## 2 Bryson C~       35.4          30.3         5            3        71
## # ... with 1 more variable: maxAQI_PM2.5 <dbl>
\end{verbatim}
