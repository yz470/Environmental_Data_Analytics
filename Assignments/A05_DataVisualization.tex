...
\NormalTok{plot7 <-}\StringTok{ }\KeywordTok{ggplot}\NormalTok{(EPA_Ecotox, }\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x=}\NormalTok{ Conc..Mean..Std.,}\DataTypeTok{color =}\NormalTok{ Chemical.Name)) }\OperatorTok{+}
