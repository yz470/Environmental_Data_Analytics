...
```{r}
#7
PubYear.anova <- lm(EPAEcotox$Pub..Year ~ EPAEcotox$Chemical.Name)
summary(PubYear.anova)
PubYear.anova2 <- aov(EPAEcotox$Pub..Year ~ EPAEcotox$Chemical.Name)
summary(PubYear.anova2)
TukeyHSD(PubYear.anova2)
...
> ANSWER: The publication years associated with these 9 different chemicals are relatively different(ANOVA; df=1274, F=33.21, p<0.0001)
