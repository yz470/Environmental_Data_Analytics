...
getwd()
library(tidyverse)
USGS.lake.data <- read.csv("../Data/Raw/NTL-LTER_Lake_ChemistryPhysics_Raw.csv")
...
> ANSWER: 1. The dataset includes information about the temperature, DO and irradiance of the Paul lake, Peter lake and Tuesday lake. 2. The data were collected from 1984 to 2016. 3. There are some "NA"s in the dataset.
