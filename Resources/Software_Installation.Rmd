...
2. Enter the path to the network drive you want to map, ie: smb://ns-gis2.win.duke.edu/env872_2019 and click ‘Connect’
3. Enter your login credentials (your Duke NetID) and click “OK”
...
**On Windows**
Navigate to the file "Login872.bat" in the Lessons folder and run.

## R

If you already have R installed, please ensure you are using the most up-to-date version. If not, follow the instructions below. If you do not have R installed, follow the instructions below.
